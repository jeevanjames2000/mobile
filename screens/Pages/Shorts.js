        ...
        <View style={styles.bottomActions}>
          ...
          <HStack space={2} alignItems="center">
            <Box
              ...
              borderWidth="0.5"
            >
              <Text color="#000" fontSize={24 * 0.5} fontWeight="bold">
                C
              </Text>
            </Box>
          ...
          >
            <HStack space={1} alignItems="center" justifyContent="center">
              <Image
                source={WhatsAppIcon}
                alt="WhatsApp Icon"
                style={{ width: 20, height: 20 }} // Adjusted for clarity
                resizeMode="contain"
              />
...
const styles = StyleSheet.create({
  ...
  bottomActions: {
    position: 'absolute',
    bottom: Platform.OS === "ios" ? SCREEN_HEIGHT * 0.11 : SCREEN_HEIGHT * 0.02,
    left: 10,
    right: 10, 
    flexDirection: 'row',
